...
func Constructor(root *TreeNode) BSTIterator { return BSTIterator{root: root} }

func (this *BSTIterator) Next() int {
	for ; this.root != nil; this.root = this.root.Left {
...
func (this *BSTIterator) HasNext() bool { return this.root != nil || len(this.stack) != 0 }

func main() {
	root := New(7)
	root.Left = New(3)
	root.Right = New(15)
	root.Right.Left = New(9)
